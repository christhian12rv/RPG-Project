...
public class ItemUtil {
    ...
    public Item criarItemVida(int v, Inventario inventario) {
        ...
        Item item = new Item(nome, descricao, tipoItem, vida, mana, inventario);
        itemService.save(item);
        return item;
    }

    public Item criarItemMana(int m, Inventario inventario) {
    ...
    public Item criarItemHibrida(int v, int m, Inventario inventario) {
